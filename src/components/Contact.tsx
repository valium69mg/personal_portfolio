...
const CONTACTS = [
  { icon: <Mail size={20} />,         label: 'Email',    value: 'carlostranquilino.cr@gmail.com', href: 'mailto:carlostranquilino.cr@gmail.com' },
  { icon: <ExternalLink size={20} />, label: 'LinkedIn', value: 'linkedin.com/in/carlos-tranquilino', href: 'https://linkedin.com/in/carlos-tranquilino' },
  { icon: <Phone size={20} />,        label: 'Phone',    value: '+52 442 273 7384', href: 'tel:+524422737384' },
];
          ...
          {CONTACTS.map(({ icon, label, value, href }, i) => (
            <a key={label} href={href}
              ...
              style={{
                ...
                padding: '1.375rem 0', borderBottom: '1px solid var(--color-border)',
